-- Fix budget_plans RLS policies to allow creators, team members, team admins, org admins/global roles, and approvers to manage budget plans.

-- Enable RLS
ALTER TABLE public.budget_plans ENABLE ROW LEVEL SECURITY;

-- Drop existing policies on budget_plans to avoid conflicts
